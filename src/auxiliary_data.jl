...
"""
struct AuxiliaryWCSData{D, C, T, S, TM, G} <: AbstractAuxiliaryWCSData
    det2im::D
    cpdis::C
    tabular::T
    spectral::S
...
AuxiliaryWCSData(; det2im = (nothing, nothing), cpdis = (nothing, nothing),
                  ...
                  time = NoTimeWCSData(), grism = NoGrismWCSData()) =
    AuxiliaryWCSData(det2im, cpdis, tabular, spectral, time, grism)
