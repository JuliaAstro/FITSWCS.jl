...
implement WCS.jl's mutating `!` methods, full status-returning transform API, or
0-origin pixel convention.
...
- stored real-header regression fixtures generated from Astropy or wcslib
- spectral physical conversions from FITS WCS Paper III
- physical interpretation of time and Stokes axes
- tabular lookup axes (`-TAB`)
- Paper IV distortion lookup tables
- full WCS.jl public API compatibility layer beyond the non-mutating aliases
- benchmarks for scalar, batch, projection, and SIP paths
